...
ModelData Cube() {
    ...
    [[maybe_unused]] Vector3 positions[]{{0.5f, 0.5f, 0.0f},  {0.5f, -0.5f, 0.0f},  {-0.5f, 0.5f, 0.0f},
                                         {0.5f, -0.5f, 0.0f}, {-0.5f, -0.5f, 0.0f}, {-0.5f, 0.5f, 0.0f}};

    auto indices = std::vector<IndexData>{};

    [[maybe_unused]] Vector3 normals[]{};
...
ModelData Square() {
    ...
    Vector3 positions[]{{0.5f, 0.5f, 0.0f}, {0.5f, -0.5f, 0.0f}, {-0.5f, -0.5f, 0.0f}, {-0.5f, 0.5f, 0.0f}};
...
ModelData ShaderToy() {
    ...
    Vector3 positions[]{{1.0f, 1.0f, 0.0f}, {1.0f, -1.0f, 0.0f}, {-1.0f, -1.0f, 0.0f}, {-1.0f, 1.0f, 0.0f}};
