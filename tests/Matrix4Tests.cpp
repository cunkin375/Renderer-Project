...
{
    auto my_mat1 = Matrix4{ { 1.0f, 2.0f, 3.0f, 4.0f, 1.0f, 2.0f, 3.0f, 4.0f, 1.0f, 2.0f, 3.0f, 4.0f, 1.0f,
                              2.0f, 3.0f, 4.0f } };

    auto my_mat2 = Matrix4{ { 1.0f, 2.0f, 3.0f, 4.0f, 1.0f, 2.0f, 3.0f, 4.0f, 1.0f, 2.0f, 3.0f, 4.0f, 1.0f,
                              2.0f, 3.0f, 4.0f } };
...
TEST(Matrix4, LookAt)
{
    ...
    auto expected = glm::lookAt(glm::vec3{ 0.0f, 1.0f, 3.0f }, glm::vec3{ 0.0f, 0.0f, 0.0f },
